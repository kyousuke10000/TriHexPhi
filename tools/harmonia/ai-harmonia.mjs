...
export async function metaAsk({userPrompt, systemHint = ""}) {
  ...
  console.log(`[Harmonia AI] Querying ${userPrompt.slice(0, 50)}...`);
  console.log(`[Harmonia AI] Intent loaded: ${intent.length} chars`);
  ...
  console.log(`[Harmonia AI] ${cands.length} candidates received`);
  ...
  console.log(`[Harmonia AI] Best: ${best.model} (score=${best.fusion_score})`);
  ...
  // Proofs/Meta に保存
  const dir = "99_SYSTEM/Proofs/Harmonia";
...
---
*Generated by Harmonia AI (7th AI) Fusion System*
`
  );

  console.log(`✅ Proof saved: ${dir}/META_${ts}.md`);
