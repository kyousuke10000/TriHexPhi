...
export async function metaAsk({userPrompt, systemHint = ""}) {
  ...
  console.log(`[Meta AI] Querying ${userPrompt.slice(0, 50)}...`);
  console.log(`[Meta AI] Intent loaded: ${intent.length} chars`);
  ...
  console.log(`[Meta AI] ${cands.length} candidates received`);
  ...
  console.log(`[Meta AI] Best: ${best.model} (score=${best.fusion_score})`);
  ...
  // Proofs/Meta に保存
  const dir = "99_SYSTEM/Proofs/Meta";
...
---
*Generated by Meta AI (7th AI) Fusion System*
`
  );
